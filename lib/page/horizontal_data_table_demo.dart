...
class HorizontalDataTableDemo extends StatefulWidget {
  HorizontalDataTableDemo({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _HorizontalDataTableDemoState createState() =>
      _HorizontalDataTableDemoState();
}
...
class _HorizontalDataTableDemoState extends State<HorizontalDataTableDemo> {
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('Phone', 500),
      _getTitleItemWidget('Register', 250),
      _getTitleItemWidget('Termination', 500),
    ];
  }
